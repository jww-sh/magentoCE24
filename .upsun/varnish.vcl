# https://gist.github.com/peterjaap/7f7bf11aa7d089792e8fcc2fb34760fa xkey vcl for magento2
import cookie;
import xkey;
...
sub vcl_recv {
    # https://docs.upsun.com/add-services/varnish.html#:~:text=sub%20vcl_recv%20%7B-,set%20req.backend_hint%20%3D%20application.backend()%3B,-%7D
